...
| **Steps** | 1. Enter `<registered email>` in Email/Username field<br>2. Enter `<valid password>` in Password field<br>3. Click **Sign In** |
...
| **Steps** | 1. Enter `<email not registered in the system>` in Email/Username<br>2. Enter `<password meeting policy>` in Password<br>3. Click **Sign In** |
...
| **Steps** | 1. Leave all fields blank<br>2. Click **Register** |
...
| **Steps** | 1. Navigate to Accounts Overview<br>2. Inspect the Account Number column for each row |
...
| **Steps** | 1. Navigate directly to the Accounts Overview URL |
...
| **Steps** | 1. Navigate to Open New Account<br>2. Select **Checking**<br>3. Enter `25` in Initial Deposit Amount<br>4. Select a funding account with balance ≥ $25<br>5. Click **Open Account** |
...
| **Steps** | 1. Select **Checking**<br>2. Enter an amount exceeding the funding account's balance (but ≥ $25)<br>3. Select the under-funded account from the dropdown<br>4. Click **Open Account** |
...
| **Steps** | 1. Navigate to Transfer Funds<br>2. Select **External Account**<br>3. Enter a valid transfer amount<br>4. Select a valid source account<br>5. Enter `<external account number>` in both External Account Number and Confirm fields<br>6. Click **Transfer** |
...
| **Steps** | 1. Select **My ParaBank Account**<br>2. Enter an amount exceeding the source account balance<br>3. Select the source account<br>4. Select a destination account<br>5. Click **Transfer** |
...
| **Steps** | 1. Navigate to Bill Payment<br>2. Fill in Payee Name, Street Address, City, State, ZIP, Phone<br>3. Enter payee account number in both Payee Account Number and Confirm Account Number<br>4. Enter a valid Payment Amount (> 0)<br>5. Select a source account with sufficient funds<br>6. Click **Pay** |
...
| **Steps** | 1. Enter `<account number A>` in Payee Account Number<br>2. Enter `<different account number B>` in Confirm Account Number<br>3. Click **Pay** |
...
| **Steps** | 1. Navigate to Request Loan<br>2. Select **Auto**<br>3. Enter a valid loan amount within the Auto range<br>4. Enter a down payment ≥ 10% and < loan amount<br>5. Select a collateral account with balance ≥ 20% of loan amount<br>6. Click **Request Loan** |
...
| **Steps** | 1. Select **Personal**<br>2. Enter an amount below $1,000 in Loan Amount<br>3. Enter a down payment otherwise meeting the 10% rule<br>4. Click **Request Loan** |
...
| **Steps** | 1. Enter `<valid first name>` in First Name<br>2. Enter `<valid last name>` in Last Name<br>3. Click **Update Profile** |
...
| **Steps** | 1. Clear the First Name field<br>2. Leave all other fields unchanged<br>3. Click **Update Profile** |
...
| **Steps** | 1. Select a Card Type<br>2. Select an account in good standing from Account to Link<br>3. Enter a complete shipping address<br>4. Click **Request Card** |
...
| **Steps** | 1. Select a valid Card Type<br>2. Select the account NOT in good standing<br>3. Enter a complete shipping address<br>4. Click **Request Card** |
...
| **Steps** | 1. Navigate to Investments<br>2. Select **Buy** from Action<br>3. Enter a valid Fund Symbol and select from autocomplete<br>4. Enter a valid quantity > 0<br>5. Select the funding account with sufficient buying power<br>6. Click **Execute Trade** |
...
| **Steps** | 1. Select **Sell**<br>2. Enter a valid Fund Symbol<br>3. Enter a quantity greater than the current share balance<br>4. Select a destination account<br>5. Click **Execute Trade** |
