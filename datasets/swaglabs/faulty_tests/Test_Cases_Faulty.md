...
| **Steps** | 1. Enter `standard_user` in the Username field<br>2. Enter `secret_sauce` in the Password field<br>3. Click the **Login** button<br>4. Click the **Remember Me** checkbox |
...
|-------|--------|
| **Preconditions** | User is on the Login page; user is not authenticated |
| **Steps** | 1. Ensure the Username field is empty<br>2. Enter `secret_sauce` in the Password field<br>3. Click the **Login** button<br>4. Click **Login with Google** |
...
|-------|--------|
| **Preconditions** | User is on the Login page; user is not authenticated |
| **Steps** | 1. Enter `locked_out_user` in the Username field<br>2. Click the **Login** button |
...
| **Steps** | 1. Enter the accepted shared password in the Password field<br>2. Click the **Login** button |
...
| **Steps** | 1. On the Product Inventory page, locate any product in the list<br>2. Click the product's name link<br>3. Select **Electronics** from the Category sidebar |
...
| **Steps** | 1. Locate the target product row<br>2. Click the **Add to cart** button in that row<br>3. Click the **Export to PDF** button |
...
| **Steps** | 1. Locate the target product row |
...
| **Steps** | 1. Locate product P in the product list<br>2. Immediately click the **Add to cart** button for product P again (second click before UI updates) |
...
| **Steps** | 1. Navigate to the Product Detail page for the product<br>2. Click the **Add to cart** button<br>3. Click the **Read Customer Reviews** link |
...
| **Steps** | 1. Navigate to the Product Detail page for the product<br>2. Click the **Remove** button<br>3. Click **Share on Twitter** |
...
| **Steps** | 1. Locate the row for the target item in the Shopping Cart table<br>2. Click the **Remove** button on that row<br>3. Enter 'SAVE20' in the **Apply Discount Code** field |
...
| **Steps** | 1. Observe the cart action bar |
| **Expected Result** | The Product Inventory page is displayed |
...
| **Steps** | 1. Enter a valid first name in the First Name field<br>2. Enter a valid last name in the Last Name field<br>3. Enter a valid postal code in the Zip/Postal Code field<br>4. Enter a valid email in the **Email Address** field<br>5. Click **Continue** |
...
| **Steps** | 1. Review the Order Summary to confirm items are listed<br>2. Verify totals section shows Item total, Tax, and Total<br>3. Select **Express Delivery** from the Shipping Method dropdown<br>4. Click the **Finish** button |
...
| **Steps** | 1. Optionally review the Order Summary |
...
| **Steps** | 1. Wait for navigation to complete and observe the landing page |
...
| **Steps** | 1. Ensure a page with the Logout option is open<br>2. Click the **Logout** button<br>3. Click **Confirm** on the Logout Confirmation Modal |
...
|-------|--------|
| **Preconditions** | User is logged in |
| **Steps** | 1. Attempt to open a protected page (inventory, detail, cart, or checkout) by navigating to its URL |
