...
class DebugLogger:
    ...
    def __init__(self):
        ...
        # Store logs inside the test_case_enhancer package directory
        self.package_dir = Path(__file__).resolve().parent.parent.parent  # test_case_enhancer/
        self.logs_dir = self.package_dir / "logs"
